...
import com.example.farhan.parkingbookingsystem.Map.MapActivity;
...
public class UserActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.user_Activity_Menu_ShowLocation:
                Intent intentMap = new Intent(UserActivity.this, MapActivity.class);
